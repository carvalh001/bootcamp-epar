...
const DetailedAnalysis = ({ inputs, results, distribution }: DetailedAnalysisProps) => {
    ...
    <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <MetricCard 
          ...
          value={`${results.stabilityScore || 0}%`} 
          icon={Shield}
        ...
        <MetricCard 
          ...
          value={`${inputs.averageContractDuration} meses`} 
          icon={Calendar}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mb-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            ...
            <span className="font-medium">{inputs.predominantGuaranteeType === "Garantia Fidejussoria" ? "Garantia Locatícia" : inputs.predominantGuaranteeType}</span>
          </div>
